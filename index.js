    ...
    el.addEventListener('click', e => {
        ...
        switch (e.target.getAttribute('data-lang')) {
            case 'JavaScript':
                ...
                break
            case 'HTML':
                document.querySelector('.about-skilled .desc').innerHTML = 'Tingkat keterampilan target<div class="progress" data-percent="20"></div><br>HTML terus terang dasar ㅎㅎ Tentu saja ejs juga dilakukan. <a href="https://ko.wikipedia.org/wiki/HTML" target="_blank">Wikipedia</a>'
                break
            case 'CSS':
