Array.from(document.querySelectorAll('.pill')).forEach(el => {
    el.addEventListener('click', e => {
        ...
        switch (e.target.getAttribute('data-lang')) {
            case 'JavaScript':
                document.querySelector('.about-skilled .desc').innerHTML = 'Tingkat keterampilan target<div class="progress" data-percent="50"></div><br>JavaScript adalah bahasa pemrograman skrip yang biasa digunakan dalam browser web. jQuery Kami berusaha untuk menghindari penggunaan punggung Anda sebanyak mungkin. Halaman ini juga seluruhnya terbuat dari JavaScript murni. <a href="https://ko.wikipedia.org/wiki/JavaScript" target="_blank">Wikipedia</a>'
                break
            case 'HTML':
